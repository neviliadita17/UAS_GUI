...
<body>
    ...
    <div class="main" id="main">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6 col-s-3 " style="overflow-x:auto; text-align: right;">
                    <h1>Nama Poli</h1>
            ...
            <div class="row">
                <div class="col-4"></div>
                <div class="col-4 col-s-3 " style="overflow-x:auto; text-align: center;">
                    <div id="form_cont" class="container">
                        <h1>Pendaftaran Antrian</h1>
                        <button id="daftar_btn" type="button" href="#">DAFTAR</button>
                    </div>
                </div>
                <div class="col-4"></div>
            </div>
