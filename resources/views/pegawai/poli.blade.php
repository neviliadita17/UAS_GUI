        ...
        <div class="header">
            <div class="row">
                <div class="col-12 col-s-12">
                    <h1>Poli <span style="float: right;"><a class="button buttonGreen" href="">Tambah Poli</a></span>
                    </h1>
                </div>
            </div>
        </div>
    ...
    new Vue({
        ...
        beforeMount() {
            this.items = Array.from(Array(10), (x, i) => {
                return {
                    No: i,
                    'Nama': Math.random().toString(36).substring(7),
                    Gambar: Math.random().toString(36).substring(7)
                }
            })
        },
        computed: {
